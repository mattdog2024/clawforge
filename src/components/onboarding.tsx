...
import { ArrowRight, ChevronDown, ChevronUp, Anvil, FolderOpen, Folder, CircleCheck } from 'lucide-react'
...
export function Onboarding({ onComplete }: OnboardingProps) {
  ...
  // Detect CLI authentication on mount
  useEffect(() => {
            ...
            <>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[13px] font-semibold text-primary">
                  {t('onboarding.anthropicApiKey')}
                  {cliDetected
                    ? <span className="text-muted font-normal ml-1.5">({t('onboarding.cliActive')})</span>
                    : <span className="text-coral font-normal ml-1"> *</span>
                  }
                </label>
